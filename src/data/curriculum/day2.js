export const day2 = {
  ...
  lessons: [
...

    {
      ...
      definition:
        "The process of understanding data before model development.",
...

    {
      ...
      whyItMatters:
        "Improves consistency and reuse across ML projects.",

      examples: [
        "Shared customer features",
        "Reusable fraud indicators"
      ],

      awsTip:
        "Amazon SageMaker Feature Store supports feature management."
    },
...

    {
      ...
      definition:
        "The process of finding optimal model settings.",
...

    {
      ...
      whyItMatters:
        "A model can become less accurate as conditions change.",
      ...
      awsTip:
        "Model drift is a common exam topic."
    },

    {
      ...
      awsTip:
        "MLOps extends DevOps concepts to machine learning."
    },
...

    {
      ...
      definition:
        "AWS's managed machine learning platform.",

      whyItMatters:
        "Frequently referenced throughout the ML lifecycle.",
...

    {
      ...
      awsTip:
        "Model Monitor is associated with monitoring and drift detection."
    }
  ...
  flashcards: [

    {
      ...
      a: "Data Preparation",
      explanation:
        "Data must be cleaned before training.",
      example:
        "Removing duplicates.",
      examTip:
...

    {
      ...
      a: "Model Drift",
      explanation:
        "Data changes can reduce model quality.",
      example:
        "Changing customer behavior.",
      examTip:
        "Monitoring helps detect drift."
    },

    {
      ...
      a: "Amazon SageMaker",
      explanation:
        "Supports training, deployment, and monitoring.",
      example:
        "Managed ML platform.",
      examTip:
        "SageMaker appears frequently on the exam."
    }
  ...
  checks: [
...

    {
      ...
      answer: 1,
      explanation:
        "Feature Store manages reusable ML features."
    },

    {
      ...
      answer: 1,
      explanation:
        "Model Monitor identifies drift and quality issues."
    }
  ...
  scenarios: [
...

    {
      ...
      explanation:
        "Model Monitor helps identify drift and quality issues."
    }
