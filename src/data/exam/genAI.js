...

{
  ...
  awsExamTip:
    "Know the major Foundation Models."
},

{
  ...
  question:
    "Why are Foundation Models considered reusable?",
  ...
  awsExamTip:
    "Pretrained + reusable = Foundation Model."
},

{
  ...
  explanation:
    "Summarization condenses content into a shorter version.",

  awsExamTip:
    "Summarization is a common GenAI use case."
},

{
  ...
  explanation:
    "Generating new content is a Generative AI capability.",

  awsExamTip:
    "Creating content = Generative AI."
},

{
  ...
  explanation:
    "Generative AI pricing is often based on token consumption.",
...

{
  ...
  explanation:
    "Higher temperature increases output variability.",
...

{
  ...
  question:
    "What is one risk associated with Generative AI systems?",
...

{
  ...
  explanation:
    "RAG retrieves information before generating responses.",
...

{
  ...
  question:
    "What does a larger context window allow?",
  ...
  awsExamTip:
    "Large documents = large context window."
},

{
  ...
  question:
    "Which content type can Generative AI create?",
  ...
  explanation:
    "Generative AI supports multiple content modalities.",

  awsExamTip:
    "GenAI is not limited to text."
},

{
  ...
  awsExamTip:
    "Deterministic outputs = lower temperature."
},

{
  ...
  awsExamTip:
    "Prompt quality strongly impacts results."
},

{
  ...
  explanation:
    "The model is generating unsupported information.",

  awsExamTip:
    "Invented facts = Hallucination."
},

{
  ...
  question:
    "What is one advantage of Foundation Models?",
  ...
  awsExamTip:
    "Pretrained models accelerate adoption."
},

{
  ...
  explanation:
    "RAG retrieves approved documents before generation.",

  awsExamTip:
    "Internal knowledge grounding usually means RAG."
}
