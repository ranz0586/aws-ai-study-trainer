...
import { buildExam } from "../utils/examBuilder";
...
export default function ExamSimulator({
  ...
  const [questions] = useState(() => {
    ...
    return buildExam(questionBank, 65);
  });
  ...
  return (
    <div className="app-container">
      ...
      {adaptive && (
        <div className="card">
          <p>
            This exam is weighted toward weak domains identified from prior
            attempts.
          </p>
        </div>
      )}
      ...
      <div className="exam-actions">
        <button className="primary-btn" onClick={submitExam}>
          Submit Exam
        </button>
      </div>
    </div>
